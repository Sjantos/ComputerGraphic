...
//Prepares tables of points to render
void initializeTables(int numberOfDivides)
{
	...
	//prepare for some scaling (probably didn't use)
	float maxABS = 0.0;
	float max = 0.0;
	for (int i = 0; i < numberOfDivides; i++)
		for (int j = 0; j < numberOfDivides; j++)
...
//Draw mountain model (ready to use in RenderScene)
...
//Prepares data provided by mouse movement
...
void main(int argc, char* argv[])
{
	...
	glutCreateWindow("OpenGL Lab4 homework");
