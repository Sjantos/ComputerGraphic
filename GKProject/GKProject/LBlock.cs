...
namespace GKProject
{
    class LBlock : BaseBlock
    {
        ...
        public LBlock(int startWidthIndex, ref GameBoardCell[,] gameBoard, int bW, MyCubeTexture texture) : base(startWidthIndex - 2, ref gameBoard, bW, texture)
        {
            actualPosition = Position.Top;
            usedCells.Add(0, new Tuple<int, int>(startWidthIndex + 2, boardHeight - 1   ));//Block indexes layout
